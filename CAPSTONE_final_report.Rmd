...
```{r permtest1, fig.cap="This figure shows the sampling distribution generated for monthly model 1 through permutation testing. The red line shows the observed value. The value for all 10000 samples is less than the observed value, providing strong support that the shock residuals have greater magnitude than the other residuals."}
