...
How do different external shocks affect the economy as a whole? What are the similarities and differences between different shocks? How does modelling economic trends surrounding these shocks differ from modelling economic trends in times without shocks?
...
* Net Exports: This data was collected from the Bureau of Economic Analysis, which collects various economic data with the purpose of getting a better understanding of the economy and modelling, particularly for government interests. This data was collected in a quarterly format, so each observation in the original represents the data for one quarter (three months).

* Consumer Confidence: This is read as the University of Michigan Consumer Sentiment value, which is observed on a monthly basis. The University of Michigan periodically updates this value with the goal of modelling a form of consumer confidence in the market. 
