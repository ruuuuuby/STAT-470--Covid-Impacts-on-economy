...
variable<-data.frame(
  ...
  Units = c('','','months','','','','','points','points',
            ...
            'points','points','points','points','points',
            'points'), Scale = c('','1-5 five sites',
                                 'Male-1 Female-2',
                                 '36-60,3-5 years','1-rare to 5-more than 5 times watch','1-home 2-school',
                                 '1-encouraged 2-not encouraged','1-32','1-58','1-20','1-54','1-17',
                                 '1-24','1-32','1-58','1-20','1-54','1-17','1-24',''))
...
df2 <- data.frame(Tests=c('Body','Letters','Forms',
                          'Numbers','RelationalTerms','Classification'),                  Mean=c(mean(sesame$bodydiff),                  mean(sesame$letdiff),mean(sesame$formdiff),                                mean(sesame$numbdiff),mean(sesame$relatdiff),mean(sesame$clasfdiff)), 
